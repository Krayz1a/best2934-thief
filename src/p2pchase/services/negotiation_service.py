...
from ..domain import core_terms, kit_seal, scent_models
...
# Re-exported: importers have said `from .negotiation_service import Handshake`
# since before the split, and moving a name is not worth breaking them over.
...
class NegotiationService:
    ...
    def handshake(self, mcp_url: str = "", opponent: str = "",
        ...
        return Handshake(
            ...
            commit_form=self.config.seal_form(opponent),
            commit_formula=kit_seal.FORMULAE.get(self.config.seal_form(opponent), ""),
